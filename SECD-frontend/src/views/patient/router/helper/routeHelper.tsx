...
import { AuthRoute } from '../routes/outsideLayout';
...
import { doctorRootRoute, patientRootRoute } from '@/router/routes/modules';
import doctorRootModules from '@/router/routes/modules/doctor';
import patientRootModules from '@/router/routes/modules/patient';
...
export const generateDynamicRoutes = (userType: string) => {
  var rootRoute, routeModules;

  switch (userType) {
    case 'doctor':
      rootRoute = doctorRootRoute;
      routeModules = doctorRootModules;
      break;
    case 'patient':
      rootRoute = patientRootRoute;
      routeModules = patientRootModules;
      break;
    default:
      return [];
  }

  const routes = [...routeModules, ...account];
